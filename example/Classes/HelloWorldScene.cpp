...
bool HelloWorld::init()
{
    ...
    CCLabelTTF* pLabel = CCLabelTTF::create("Hello applovin-x", "Arial", TITLE_FONT_SIZE);
...
void HelloWorld::didLoadAd(const char* lable)
{
...
void HelloWorld::didFailToLoadAdWithError(int code)
{
